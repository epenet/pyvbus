...
class TestException(unittest.TestCase):
    ...
    def test_parsingexception(self):
        #missing sync byte
        self.assertRaises(vbuspacket.VBUSPacketException, lambda: vbuspacket.VBUSPacket(bytearray.fromhex("000000000000000000")))
        #buffer to small (less than 6)
        self.assertRaises(vbuspacket.VBUSPacketException, lambda: vbuspacket.VBUSPacket(bytearray.fromhex("aa00000000")))
        #invalid protocol
        self.assertRaises(vbuspacket.VBUSPacketException, lambda: vbuspacket.VBUSPacket(bytearray.fromhex("aa0000000030")))

    def test_parsingprotocol1(self):
        #buffer to small (less than 10)
        self.assertRaises(vbuspacket.VBUSPacketException, lambda: vbuspacket.VBUSPacket(bytearray.fromhex("aa0000000010")))
        #invalid header checksum
        self.assertRaises(vbuspacket.VBUSPacketException, lambda: vbuspacket.VBUSPacket(bytearray.fromhex("aa000000001000000000")))
        #invalid frame count
        self.assertRaises(vbuspacket.VBUSPacketException, lambda: vbuspacket.VBUSPacket(bytearray.fromhex("aa00000000100000016e")))
        #MSB not allowed
        self.assertRaises(vbuspacket.VBUSPacketException, lambda: vbuspacket.VBUSPacket(bytearray.fromhex("aa00000000100000016eff0000000000")))
        #invalid frame checksum
        self.assertRaises(vbuspacket.VBUSPacketException, lambda: vbuspacket.VBUSPacket(bytearray.fromhex("aa00000000100000016e000000000000")))
        #valid fake packet
        self.assertIsInstance(vbuspacket.VBUSPacket(bytearray.fromhex("aa00000000100000016e00000000007f")), vbuspacket.VBUSPacket)


class Test_0x7321(unittest.TestCase):

    def setUp(self):
        hexbuffer = "aa1000217310000112385d000000041e0c001501015c5b012801007a25013822047b7c03382204223822382205465d020000011f00000000007f00000000007f000e000001703b000000004400000000007f00000000007f00000000007f00002d00005200000000007f01034503042f02000000007d"
